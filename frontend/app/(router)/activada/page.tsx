...
export default function Page({searchParams,}: {searchParams: { [key: string]: string | string[] | undefined } }) {
  ...
  return (
      ...
      <div className='bg-#1E1E1E'>
        ...
        <p className='w-[300px] sm:w-[600px] font-extrabold text-center text-[1.5rem]'>{firstName} {lastName}  su cuenta ha sido creada y activada exitosamente con el siguiente email: {email}</p>
        <Link href={"/acceso"} >
